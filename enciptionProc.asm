...
;DO 	:opens file
;IN  	: ah, al, dx, [local_filehandle]. [ErrorMsg]
;OUT 	: opens file and [local_filehandle] maybey with eror msg
;EFFECTED REGISTERS : AH, DX, [local_filehandle]
proc OpenFile
...
;   IN: [time_play] , [note], [message], [secret_msg], [press_key], [chip_pic, [key_enter], [enter_mesege_print]
;   OUT:  chage in graficks and chnges this varibales: 
...
;   IN:NONE
;   OUT:  [key]
;	AFFECTED REGISTERS AND VARIABLES: [key]
; ==============================================
proc getKey
...
;IN  	: [message], [key]
;OUT 	: [meesege], [char]
;EFFECTED REG AND VARIABLES NONE but vatibale : [char], [message]
proc xor_arr_chip
	PUSHA ;save the registors
...
;IN  	: [char] - the chat to chip and [key]
;OUT 	: [char] - the chi[ped num 
...
;IN  	: None
;OUT 	: no just resets the [meesege] and [secret_msg]
